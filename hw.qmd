...
This allows for easier management of packages and dependencies, ensuring your code will run and not be affected by any updates outside of the isolated environment.  It also makes it easier to reproduce projects by having specific versions installed in the isolated environment.

1. In your terminal, navigate to your project's root directory.  I made the mistake of setting up my virtual environment in the project directory but it has to be set up in the directory above.  
