...
This step is fairly straightforward and follows a similar installation process to other programs.  The code in the following steps uses VSCode now we are setting up our computers to be able to use .qmd files in VSCode.  First, we must install Quarto on our computers, it can be found in this link: [Get Started](https://quarto.org/docs/get-started/).  You can choose your operating system follow the installation steps.
